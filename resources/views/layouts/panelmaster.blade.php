...
<!-- Mirrored from mannatthemes.com/dastone/default/demo-dark.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Aug 2021 04:53:20 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Panel Admin</title>
        <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
        <meta content="Match and Work Admin Panel" name="description" />
        ...
        <!-- jvectormap -->
        <link href="https://mannatthemes.com/dastone/plugins/jvectormap/jquery-jvectormap-2.0.2.css" rel="stylesheet">
        ...
        <link href="{{URL::asset('panel/assets/css/metisMenu.min.css')}}" rel="stylesheet" type="text/css" />
    ...
    <body class="dark-sidenav">
        ...
        <div class="left-sidenav">
            ...
            <div class="brand">
                <a href="index.html" class="logo">
                    <span>
                        <img src="{{URL::asset('panel/assets/images/dark mnw.webp')}}" alt="logo-small" class="logo-sm">
                    </span>
                    <span>
                        <img src="{{URL::asset('panel/assets/images/dark mnw.webp')}}" alt="logo-large" class="logo-lg logo-light">
                        <img src="{{URL::asset('panel/assets/images/dark mnw.webp')}}" alt="logo-large" class="logo-lg logo-dark">
                    </span>
                </a>
            </div>
            <!--end logo-->
            <div class="menu-content h-100" data-simplebar>
                ...
                <div class="update-msg text-center">
                    ...
                    <h5 class="mt-3">Match and Work Panel</h5>
                    <p class="mb-3">On Progress Sidebar</p>
                    <a href="javascript: void(0);" class="btn btn-outline-warning btn-sm">Weekly Sprint</a>
                </div>
            </div>
        </div>
        <!-- end left-sidenav-->
                    ...
                    <ul class="list-unstyled topbar-nav float-end mb-0">
                        ...
                        <li class="dropdown">
                            <a class="nav-link dropdown-toggle waves-effect waves-light nav-user" data-bs-toggle="dropdown" href="#" role="button"
                                aria-haspopup="false" aria-expanded="false">
                                <span class="ms-1 nav-user-name hidden-sm">{{Auth::user()->first_name}}</span>
                                <img src="{{ Auth::user()->profile_photo_url }}" alt="profile-user" class="rounded-circle thumb-xs" />
                            </a>
        ...
        <script src="{{URL::asset('panel/assets/js/metismenu.min.js')}}"></script>
        ...
        <script src="{{URL::asset('panel/assets/js/moment.js')}}"></script>
        ...
        <script src="https://mannatthemes.com/dastone/plugins/jvectormap/jquery-jvectormap-2.0.2.min.js"></script>
        <script src="https://mannatthemes.com/dastone/plugins/jvectormap/jquery-jvectormap-us-aea-en.js"></script>
        <script src="{{URL::asset('panel/assets/pages/jquery.analytics_dashboard.init.js')}}"></script>

        <!-- App js -->
        <script src="{{URL::asset('panel/assets/js/app.js')}}"></script>

    </body>


<!-- Mirrored from mannatthemes.com/dastone/default/demo-dark.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Aug 2021 04:55:25 GMT -->
</html>
